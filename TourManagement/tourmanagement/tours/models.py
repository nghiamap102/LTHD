...
class Booking(models.Model):
    ...
    # @property
    # def total(self):
    #     return int(int(self.tour_detail.final_price) * self.adult
...
class PriceRoom(models.Model):
    ...
    def __str__(self):
        return self.tour_detail.name


class PriceTour(models.Model):
    price = models.IntegerField()  # gia tour
    discount = models.IntegerField(default=0)
    tour_detail = models.ForeignKey(TourDetail, related_name="price_tour", on_delete=models.CASCADE)


class PriceBooking(models.Model):
    price = models.IntegerField()  # gia tour
    booking = models.ForeignKey(Booking, related_name="price_booking", on_delete=models.CASCADE)
...
class Point(models.Model):
    class Meta:
        unique_together = ['customer', "created_date"]
