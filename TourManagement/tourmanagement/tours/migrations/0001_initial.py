# Generated by Django 3.2.5 on 2021-10-09 07:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_tour', to='tours.tourdetail')),
            ],
        ),
        migrations.CreateModel(
            name='PriceRoom',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.IntegerField()),
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='price_booking', to='tours.booking')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='booking',
            name='tour_detail',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking', to='tours.tourdetail'),
        ),
        migrations.CreateModel(
            name='Blog',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('type', models.PositiveSmallIntegerField(choices=[(0, 'like'), (1, 'haha'), (2, 'heart'), (3, 'sad'), (4, 'angry')], default=0)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tours.tourdetail')),
            ],
            options={
