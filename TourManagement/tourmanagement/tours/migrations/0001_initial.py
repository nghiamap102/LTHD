# Generated by Django 3.2.5 on 2021-08-30 06:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ManyToManyField(blank=True, null=True, related_name='toursdetail', to='tours.Hotel')),
                ('tours', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tours.tourstotal')),
                ('transport', models.ManyToManyField(blank=True, null=True, related_name='toursdetail', to='tours.Transport')),
            ],
            options={
